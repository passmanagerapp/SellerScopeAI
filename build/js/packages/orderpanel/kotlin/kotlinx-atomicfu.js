(function (factory) {
  ...
  protoOf(AtomicRef).nl = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).ol = function () {
  ...
  protoOf(AtomicBoolean).pl = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).ol = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).ql = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).ol = function () {
    return this.kotlinx$atomicfu$value;
  };
